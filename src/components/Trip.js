    ...
    return(
        <div className="trip">
            ...
            <div className="tripcard">
                ...
                text ="Malaysia is a Southeast Asian country occupying parts of the Malay Peninsula and the island of Borneo. It's known for its beaches, rainforests and mix of Malay, Chiness, Indian and European cultural influences."
                />
